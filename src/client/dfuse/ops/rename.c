		...
		const char *newname)
{
	...
	/* If the move is not from where we thought this inode was then invalidate the old entry */
		...
		const char *newname, unsigned int flags)
{
	...
	/* TODO: Update the thing that got moved */
	...
	dfuse_oid_unlinked(fs_handle, old_inode, newparent, newname);
	return;
