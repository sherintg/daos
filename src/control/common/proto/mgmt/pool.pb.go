...
type PoolCreateReq_ScrubScheds int32

const (
	PoolCreateReq_off        PoolCreateReq_ScrubScheds = 0
	PoolCreateReq_wait       PoolCreateReq_ScrubScheds = 1
	PoolCreateReq_continuous PoolCreateReq_ScrubScheds = 2
	PoolCreateReq_run_once   PoolCreateReq_ScrubScheds = 3
	PoolCreateReq_no_yield   PoolCreateReq_ScrubScheds = 4
)

// Enum value maps for PoolCreateReq_ScrubScheds.
var (
	PoolCreateReq_ScrubScheds_name = map[int32]string{
		0: "off",
		1: "wait",
		2: "continuous",
		3: "run_once",
	...
	PoolCreateReq_ScrubScheds_value = map[string]int32{
		"off":        0,
		"wait":       1,
		"continuous": 2,
		"run_once":   3,
...
func (x PoolCreateReq_ScrubScheds) Enum() *PoolCreateReq_ScrubScheds {
	p := new(PoolCreateReq_ScrubScheds)
	*p = x
	return p
}

func (x PoolCreateReq_ScrubScheds) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (PoolCreateReq_ScrubScheds) Descriptor() protoreflect.EnumDescriptor {
	return file_mgmt_pool_proto_enumTypes[0].Descriptor()
}

func (PoolCreateReq_ScrubScheds) Type() protoreflect.EnumType {
	return &file_mgmt_pool_proto_enumTypes[0]
}

func (x PoolCreateReq_ScrubScheds) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use PoolCreateReq_ScrubScheds.Descriptor instead.
func (PoolCreateReq_ScrubScheds) EnumDescriptor() ([]byte, []int) {
	return file_mgmt_pool_proto_rawDescGZIP(), []int{0, 0}
}
...
type PoolCreateReq struct {
	...
	Label     string   `protobuf:"bytes,2,opt,name=label,proto3" json:"label,omitempty"`         // Unique label for pool (optional)
	...
	Scrubsched   PoolCreateReq_ScrubScheds `protobuf:"varint,15,opt,name=scrubsched,proto3,enum=mgmt.PoolCreateReq_ScrubScheds" json:"scrubsched,omitempty"` // Checksum scrubbing schedule (manual config)
	Scrubfreq    uint32                    `protobuf:"varint,16,opt,name=scrubfreq,proto3" json:"scrubfreq,omitempty"`                                       // checksum scrubbing frequency (manual config)
	Scrubcred    uint32                    `protobuf:"varint,17,opt,name=scrubcred,proto3" json:"scrubcred,omitempty"`                                       // checksum scrubbing credits (manual config)
}
...
func (x *PoolCreateReq) GetLabel() string {
	if x != nil {
		return x.Label
	}
	return ""
...
func (x *PoolCreateReq) GetScrubsched() PoolCreateReq_ScrubScheds {
	if x != nil {
		return x.Scrubsched
	}
	return PoolCreateReq_off
}

func (x *PoolCreateReq) GetScrubfreq() uint32 {
	if x != nil {
		return x.Scrubfreq
	}
	return 0
...
func (x *PoolCreateReq) GetScrubcred() uint32 {
	if x != nil {
		return x.Scrubcred
	}
	return 0
...
type PoolExtendResp struct {
	...
	Status    int32  `protobuf:"varint,1,opt,name=status,proto3" json:"status,omitempty"`                        // DAOS error code
	ScmBytes  uint64 `protobuf:"varint,2,opt,name=scm_bytes,json=scmBytes,proto3" json:"scm_bytes,omitempty"`    // SCM allocated on rank(s)
	NvmeBytes uint64 `protobuf:"varint,3,opt,name=nvme_bytes,json=nvmeBytes,proto3" json:"nvme_bytes,omitempty"` // NVMe allocated on rank(s)
}
...
func (x *PoolExtendResp) GetScmBytes() uint64 {
	if x != nil {
		return x.ScmBytes
	}
	return 0
...
func (x *PoolExtendResp) GetNvmeBytes() uint64 {
	if x != nil {
		return x.NvmeBytes
	}
	return 0
...
type PoolScrubberInfo struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Schedule uint32 `protobuf:"varint,1,opt,name=schedule,proto3" json:"schedule,omitempty"`
}

func (x *PoolScrubberInfo) Reset() {
	*x = PoolScrubberInfo{}
	if protoimpl.UnsafeEnabled {
...
func (x *PoolScrubberInfo) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PoolScrubberInfo) ProtoMessage() {}

func (x *PoolScrubberInfo) ProtoReflect() protoreflect.Message {
	mi := &file_mgmt_pool_proto_msgTypes[23]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PoolScrubberInfo.ProtoReflect.Descriptor instead.
func (*PoolScrubberInfo) Descriptor() ([]byte, []int) {
	return file_mgmt_pool_proto_rawDescGZIP(), []int{23}
}

func (x *PoolScrubberInfo) GetSchedule() uint32 {
	if x != nil {
		return x.Schedule
	}
	return 0
...
type PoolQueryResp struct {
	...
	Scm             *StorageUsageStats `protobuf:"bytes,8,opt,name=scm,proto3" json:"scm,omitempty"`                                                 // SCM storage usage stats
	Nvme            *StorageUsageStats `protobuf:"bytes,9,opt,name=nvme,proto3" json:"nvme,omitempty"`                                               // NVMe storage usage stats
	TotalNodes      uint32             `protobuf:"varint,10,opt,name=total_nodes,json=totalNodes,proto3" json:"total_nodes,omitempty"`               // total nodes in pool
	Version         uint32             `protobuf:"varint,11,opt,name=version,proto3" json:"version,omitempty"`                                       // latest pool map version
	Leader          uint32             `protobuf:"varint,12,opt,name=leader,proto3" json:"leader,omitempty"`                                         // current raft leader
}
...
var file_mgmt_pool_proto_rawDesc = []byte{
	...
	0x6f, 0x12, 0x04, 0x6d, 0x67, 0x6d, 0x74, 0x22, 0xc8, 0x04, 0x0a, 0x0d, 0x50, 0x6f, 0x6f, 0x6c,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x75, 0x75, 0x69, 0x64, 0x22, 0x51, 0x0a, 0x0c, 0x50, 0x6f,
	0x6f, 0x6c, 0x51, 0x75, 0x65, 0x72, 0x79, 0x52, 0x65, 0x71, 0x12, 0x10, 0x0a, 0x03, 0x73, 0x79,
	0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x73, 0x79, 0x73, 0x12, 0x12, 0x0a, 0x04,
	0x75, 0x75, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x75, 0x75, 0x69, 0x64,
	0x12, 0x1b, 0x0a, 0x09, 0x73, 0x76, 0x63, 0x5f, 0x72, 0x61, 0x6e, 0x6b, 0x73, 0x18, 0x03, 0x20,
	0x03, 0x28, 0x0d, 0x52, 0x08, 0x73, 0x76, 0x63, 0x52, 0x61, 0x6e, 0x6b, 0x73, 0x22, 0x75, 0x0a,
	0x11, 0x53, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x55, 0x73, 0x61, 0x67, 0x65, 0x53, 0x74, 0x61,
	...
	,
	...
	,
	...
	,
...
var file_mgmt_pool_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_mgmt_pool_proto_msgTypes = make([]protoimpl.MessageInfo, 29)
var file_mgmt_pool_proto_goTypes = []interface{}{
	(PoolCreateReq_ScrubScheds)(0), // 0: mgmt.PoolCreateReq.Scrub_scheds
	(PoolRebuildStatus_State)(0),   // 1: mgmt.PoolRebuildStatus.State
	(*PoolCreateReq)(nil),          // 2: mgmt.PoolCreateReq
	(*PoolCreateResp)(nil),         // 3: mgmt.PoolCreateResp
	(*PoolDestroyReq)(nil),         // 4: mgmt.PoolDestroyReq
	(*PoolDestroyResp)(nil),        // 5: mgmt.PoolDestroyResp
	(*PoolEvictReq)(nil),           // 6: mgmt.PoolEvictReq
	(*PoolEvictResp)(nil),          // 7: mgmt.PoolEvictResp
	(*PoolExcludeReq)(nil),         // 8: mgmt.PoolExcludeReq
	(*PoolExcludeResp)(nil),        // 9: mgmt.PoolExcludeResp
	(*PoolDrainReq)(nil),           // 10: mgmt.PoolDrainReq
	(*PoolDrainResp)(nil),          // 11: mgmt.PoolDrainResp
	(*PoolExtendReq)(nil),          // 12: mgmt.PoolExtendReq
	(*PoolExtendResp)(nil),         // 13: mgmt.PoolExtendResp
	(*PoolReintegrateReq)(nil),     // 14: mgmt.PoolReintegrateReq
	(*PoolReintegrateResp)(nil),    // 15: mgmt.PoolReintegrateResp
	(*ListPoolsReq)(nil),           // 16: mgmt.ListPoolsReq
	(*ListPoolsResp)(nil),          // 17: mgmt.ListPoolsResp
	(*PoolResolveIDReq)(nil),       // 18: mgmt.PoolResolveIDReq
	(*PoolResolveIDResp)(nil),      // 19: mgmt.PoolResolveIDResp
	...
	(*PoolScrubberInfo)(nil),       // 25: mgmt.PoolScrubberInfo
	...
	(*ListPoolsResp_Pool)(nil),     // 29: mgmt.ListPoolsResp.Pool
	(*ListContResp_Cont)(nil),      // 30: mgmt.ListContResp.Cont
}
var file_mgmt_pool_proto_depIdxs = []int32{
	0,  // 0: mgmt.PoolCreateReq.scrubsched:type_name -> mgmt.PoolCreateReq.Scrub_scheds
	29, // 1: mgmt.ListPoolsResp.pools:type_name -> mgmt.ListPoolsResp.Pool
	30, // 2: mgmt.ListContResp.containers:type_name -> mgmt.ListContResp.Cont
	1,  // 3: mgmt.PoolRebuildStatus.state:type_name -> mgmt.PoolRebuildStatus.State
	24, // 4: mgmt.PoolQueryResp.rebuild:type_name -> mgmt.PoolRebuildStatus
	23, // 5: mgmt.PoolQueryResp.scm:type_name -> mgmt.StorageUsageStats
	23, // 6: mgmt.PoolQueryResp.nvme:type_name -> mgmt.StorageUsageStats
...
func file_mgmt_pool_proto_init() {
	...
	file_mgmt_pool_proto_msgTypes[26].OneofWrappers = []interface{}{
