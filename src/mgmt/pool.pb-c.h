...
typedef struct Mgmt__PoolCreateReq Mgmt__PoolCreateReq;
typedef struct Mgmt__PoolCreateResp Mgmt__PoolCreateResp;
typedef struct Mgmt__PoolDestroyReq Mgmt__PoolDestroyReq;
typedef struct Mgmt__PoolDestroyResp Mgmt__PoolDestroyResp;
typedef struct Mgmt__PoolEvictReq Mgmt__PoolEvictReq;
typedef struct Mgmt__PoolEvictResp Mgmt__PoolEvictResp;
typedef struct Mgmt__PoolExcludeReq Mgmt__PoolExcludeReq;
typedef struct Mgmt__PoolExcludeResp Mgmt__PoolExcludeResp;
typedef struct Mgmt__PoolDrainReq Mgmt__PoolDrainReq;
typedef struct Mgmt__PoolDrainResp Mgmt__PoolDrainResp;
typedef struct Mgmt__PoolExtendReq Mgmt__PoolExtendReq;
typedef struct Mgmt__PoolExtendResp Mgmt__PoolExtendResp;
typedef struct Mgmt__PoolReintegrateReq Mgmt__PoolReintegrateReq;
typedef struct Mgmt__PoolReintegrateResp Mgmt__PoolReintegrateResp;
typedef struct Mgmt__ListPoolsReq Mgmt__ListPoolsReq;
typedef struct Mgmt__ListPoolsResp Mgmt__ListPoolsResp;
typedef struct Mgmt__ListPoolsResp__Pool Mgmt__ListPoolsResp__Pool;
typedef struct Mgmt__PoolResolveIDReq Mgmt__PoolResolveIDReq;
typedef struct Mgmt__PoolResolveIDResp Mgmt__PoolResolveIDResp;
typedef struct Mgmt__ListContReq Mgmt__ListContReq;
typedef struct Mgmt__ListContResp Mgmt__ListContResp;
typedef struct Mgmt__ListContResp__Cont Mgmt__ListContResp__Cont;
typedef struct Mgmt__PoolQueryReq Mgmt__PoolQueryReq;
typedef struct Mgmt__StorageUsageStats Mgmt__StorageUsageStats;
typedef struct Mgmt__PoolRebuildStatus Mgmt__PoolRebuildStatus;
typedef struct Mgmt__PoolScrubberInfo Mgmt__PoolScrubberInfo;
typedef struct Mgmt__PoolQueryResp Mgmt__PoolQueryResp;
typedef struct Mgmt__PoolSetPropReq Mgmt__PoolSetPropReq;
typedef struct Mgmt__PoolSetPropResp Mgmt__PoolSetPropResp;


/* --- enums --- */

typedef enum _Mgmt__PoolCreateReq__ScrubScheds {
  MGMT__POOL_CREATE_REQ__SCRUB_SCHEDS__off = 0,
  MGMT__POOL_CREATE_REQ__SCRUB_SCHEDS__wait = 1,
  MGMT__POOL_CREATE_REQ__SCRUB_SCHEDS__continuous = 2,
  MGMT__POOL_CREATE_REQ__SCRUB_SCHEDS__run_once = 3,
  MGMT__POOL_CREATE_REQ__SCRUB_SCHEDS__no_yield = 4
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(MGMT__POOL_CREATE_REQ__SCRUB_SCHEDS)
} Mgmt__PoolCreateReq__ScrubScheds;
...
struct  Mgmt__PoolCreateReq
{
  ...
  uint64_t nvmebytes;
  /*
   * Checksum scrubbing schedule (manual config)
   */
  Mgmt__PoolCreateReq__ScrubScheds scrubsched;
  /*
   * checksum scrubbing frequency (manual config)
   */
  uint32_t scrubfreq;
  /*
   * checksum scrubbing credits (manual config)
   */
  uint32_t scrubcred;
};
#define MGMT__POOL_CREATE_REQ__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&mgmt__pool_create_req__descriptor) \
    , (char *)protobuf_c_empty_string, (char *)protobuf_c_empty_string, (char *)protobuf_c_empty_string, (char *)protobuf_c_empty_string, (char *)protobuf_c_empty_string, 0,NULL, 0,NULL, 0, 0, 0, 0, 0,NULL, 0, 0, MGMT__POOL_CREATE_REQ__SCRUB_SCHEDS__off, 0, 0 }


/*
 * PoolCreateResp returns created pool uuid and ranks.
 */
struct  Mgmt__PoolCreateResp
{
  ProtobufCMessage base;
  /*
   * DAOS error code
 ...
 */
struct  Mgmt__PoolReintegrateReq
{
  ProtobufCMessage base;
  /*
   * DAOS system identifier
 ...
 */
struct  Mgmt__PoolReintegrateResp
{
  ProtobufCMessage base;
  /*
   * DAOS error code
...
struct  Mgmt__ListPoolsResp__Pool
{
  ProtobufCMessage base;
  /*
   * uuid of pool
 ...
 */
struct  Mgmt__PoolResolveIDResp
{
  ProtobufCMessage base;
  /*
...
struct  Mgmt__ListContResp__Cont
{
  ProtobufCMessage base;
  /*
   * uuid of container
 ...
 */
struct  Mgmt__StorageUsageStats
{
  ProtobufCMessage base;
  uint64_t total;
  uint64_t free;
 ...
 */
struct  Mgmt__PoolRebuildStatus
{
  ProtobufCMessage base;
  /*
   * DAOS error code
...
struct  Mgmt__PoolScrubberInfo
{
  ProtobufCMessage base;
  uint32_t schedule;
};
#define MGMT__POOL_SCRUBBER_INFO__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&mgmt__pool_scrubber_info__descriptor) \
    , 0 }
...
typedef enum {
  ...
  MGMT__POOL_SET_PROP_REQ__PROPERTY_NUMBER = 4
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(MGMT__POOL_SET_PROP_REQ__PROPERTY__CASE)
...
typedef enum {
  ...
  MGMT__POOL_SET_PROP_REQ__VALUE_NUMVAL = 6
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(MGMT__POOL_SET_PROP_REQ__VALUE__CASE)
} Mgmt__PoolSetPropReq__ValueCase;

/*
 * PoolSetPropReq represents a request to set a pool property.
 */
struct  Mgmt__PoolSetPropReq
{
  ProtobufCMessage base;
  /*
   * DAOS system identifier
...
typedef enum {
  ...
  MGMT__POOL_SET_PROP_RESP__PROPERTY_NUMBER = 3
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(MGMT__POOL_SET_PROP_RESP__PROPERTY__CASE)
...
typedef enum {
  ...
  MGMT__POOL_SET_PROP_RESP__VALUE_NUMVAL = 5
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(MGMT__POOL_SET_PROP_RESP__VALUE__CASE)
} Mgmt__PoolSetPropResp__ValueCase;

/*
 * PoolSetPropResp represents the result of setting a property.
 */
struct  Mgmt__PoolSetPropResp
{
  ProtobufCMessage base;
  /*
   * DAOS error code
...
void   mgmt__pool_rebuild_status__free_unpacked
                     (Mgmt__PoolRebuildStatus *message,
                      ProtobufCAllocator *allocator);
/* Mgmt__PoolScrubberInfo methods */
void   mgmt__pool_scrubber_info__init
                     (Mgmt__PoolScrubberInfo         *message);
size_t mgmt__pool_scrubber_info__get_packed_size
                     (const Mgmt__PoolScrubberInfo   *message);
size_t mgmt__pool_scrubber_info__pack
                     (const Mgmt__PoolScrubberInfo   *message,
                      uint8_t             *out);
size_t mgmt__pool_scrubber_info__pack_to_buffer
                     (const Mgmt__PoolScrubberInfo   *message,
                      ProtobufCBuffer     *buffer);
Mgmt__PoolScrubberInfo *
       mgmt__pool_scrubber_info__unpack
                     (ProtobufCAllocator  *allocator,
                      size_t               len,
                      const uint8_t       *data);
void   mgmt__pool_scrubber_info__free_unpacked
                     (Mgmt__PoolScrubberInfo *message,
                      ProtobufCAllocator *allocator);
...
typedef void (*Mgmt__PoolRebuildStatus_Closure)
                 (const Mgmt__PoolRebuildStatus *message,
                  void *closure_data);
typedef void (*Mgmt__PoolScrubberInfo_Closure)
                 (const Mgmt__PoolScrubberInfo *message,
                  void *closure_data);
...
extern const ProtobufCEnumDescriptor    mgmt__pool_create_req__scrub_scheds__descriptor;
...
extern const ProtobufCMessageDescriptor mgmt__pool_scrubber_info__descriptor;
